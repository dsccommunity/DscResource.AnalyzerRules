...
Describe 'Test-StatementOpeningParenthsesOnSameLine' -Tag 'Private' {
    Context 'When statement has an opening parentheses on the same line' {
        It 'Should return $true' {
            InModuleScope -ScriptBlock {
                ...
                $testStatementOpeningParenthsesOnSameLineResult | Should -BeTrue
            }
        }
    }
    ...
    Context 'When statement does not have an opening parentheses on the same line' {
        It 'Should return $false' {
            InModuleScope -ScriptBlock {
                ...
                $testStatementOpeningParenthsesOnSameLineResult | Should -BeFalse
            }
        }
    }
}
